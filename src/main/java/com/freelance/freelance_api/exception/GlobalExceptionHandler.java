...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleRuntimeException(RuntimeException ex){
        ...
        problemDetail.setType(URI.create("/errors/bad-request")); // RFC 7807 изисква URI тип на грешката
        problemDetail.setProperty("timestamp", System.currentTimeMillis()); // Добавяме ти времева марка като екстра
